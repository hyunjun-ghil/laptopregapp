function setupLiveReader_register(resultElement) {
  ...
  navigator.mediaDevices
    ...
    .then(function(stream) {
      ...
      const inputbar = document.querySelector('input[type="range"]');

      // Map zoom to a slider element.
      inputbar.min = capabilities.zoom.min;
      inputbar.max = capabilities.zoom.max;
      inputbar.step = capabilities.zoom.step;
      inputbar.value = settings.value;
