 ...
 * Generated at: 2022-02-18 08:53:58 UTC
...
public final class returnPageManual_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tvar selRowData = $(\"#returnjqGrid\")\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.jqGrid(\"getRowData\", rowid);\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"#modal_userid\").val(\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tselRowData.UserID);\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"#modal_username\").val(\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tselRowData.UserNM);\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"#modal_deptname\").val(\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tselRowData.DEPTNM);\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"#modal_serial\").val(\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tselRowData.SerialNumber);\n");
      out.write("\t\t\t\t\t\t\t\t\t},\n");
      out.write("\t\t\t\t\t\t\t\t});\n");
      out.write("\n");
      out.write("\t\t\t\t//다시 로드 \n");
      ...
      out.write("\t\t\t});\n");
      out.write("\n");
      out.write("\t$(\"#modelReturnBtn\").on(\"click\",\n");
      out.write("\t\t\t\t\tfunction(e) { //KD/파트너\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\ttype : \"post\",\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdata : {\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\"UserNM\" : $(\"#modal_username\")\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t.val(),\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\"UserID\" : $(\"#modal_userid\").val(),\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\"DEPTNM\" : $(\"#modal_deptname\")\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t.val(),\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\ttextStatus, errorThrown) { // 비동기 통신이 실패할경우 error 콜백으로 들어옵니다.\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\ttype : \"post\",\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdata : {\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\"returnSerial\" : $(\"#returnSerial\")\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t.val()\n");
      out.write("\t\t\t\t\t\t\t\t\t\t},\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdataType : \"json\",\n");
      out.write("\t\t\t\t\t\t\t\t\t\tloadtext : \"loading...\",\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t};\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tconsole\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.log(rowdata);\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tjQuery(\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\"#returnjqGrid\")\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.jqGrid(\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t'addRowData',\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ti,\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\trowdata);\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t$(\"#returnjqGrid\").jqGrid(\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t'setGridParam', {\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata : data.listData\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t$(\"#returnjqGrid\").trigger(\n");
